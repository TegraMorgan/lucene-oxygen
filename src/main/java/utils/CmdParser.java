...
public class CmdParser {
    ...
    public void extract(String[] args) throws Exception {
        ...
        try {
            Option lambda = new Option("l", "lambda", false, "Create appropriate lambda for language model, depends on median size of document in corpus");
